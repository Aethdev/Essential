	...
	client.Tween = {
		create = function(obj, tweenInfo, properties)
			...
			local triggerPlay = function()
				local canTween = (service.playerGui and obj:IsDescendantOf(service.playerGui))
			...
			local triggerPause = function() animPause(tweenAnim) end

			local triggerStop = function() animStop(tweenAnim) end

			local triggerCancel = function() animCancel(tweenAnim) end
